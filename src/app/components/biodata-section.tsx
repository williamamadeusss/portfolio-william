  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-14 px-4 font-montserrat lg:absolute lg:w-[65%] lg:gap-12 lg:px-0 lg:pl-10 lg:pt-16 xl:gap-16 xl:pl-20 xl:pt-28">
        <h1 className="lg:text-smallMediumHeading border-b-[6px] border-primary pb-3 text-center text-title font-bold tracking-wide lg:pb-6 lg:text-left lg:font-semibold xl:text-mediumHeading">
          WILLIAM AMADEUS
        </h1>

        <div className="lg:text-mediumBigHeading flex flex-col items-end justify-end gap-10 text-right text-smallHeading font-extrabold tracking-wide xl:text-bigHeading">
